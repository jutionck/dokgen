  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="profil" className="space-y-6">
        <TabsList
          aria-label="Pengaturan perusahaan"
          className="flex h-auto w-full max-w-none justify-start gap-1 overflow-x-auto overscroll-x-contain rounded-2xl border border-slate-200 bg-slate-100/90 p-1.5 shadow-inner shadow-slate-200/30 sm:justify-start sm:gap-1.5 md:grid md:grid-cols-4 md:overflow-visible"
        >
          <TabsTrigger value="profil" className={settingsTabClass}>
            <Building2 className="h-4 w-4" /> Profil Perusahaan
          </TabsTrigger>
          <TabsTrigger value="bank" className={settingsTabClass}>
            <Landmark className="h-4 w-4" /> Bank & Pembayaran
          </TabsTrigger>
          <TabsTrigger value="signer" className={settingsTabClass}>
            <PenLine className="h-4 w-4" /> Penandatangan
          </TabsTrigger>
          <TabsTrigger value="team" className={settingsTabClass}>
        ...
        <TabsContent value="signer">
          <Card className="border-slate-200/80 shadow-xs rounded-2xl overflow-hidden">
            ...
            <CardContent className="p-5 sm:p-6 space-y-5">
              <div className="grid gap-5 rounded-2xl border border-slate-200/80 bg-slate-50/70 p-4 sm:grid-cols-[220px_1fr] sm:items-center sm:p-5">
                <div className="flex h-32 items-center justify-center overflow-hidden rounded-xl border border-dashed border-slate-300 bg-white p-3 shadow-2xs">
                  {company.signature_url ? (
                    ...
                    <div className="text-center text-slate-400">
                      ...
                      <p className="mt-2 text-[11px] font-medium">Belum ada tanda tangan</p>
                    </div>
                  )}
                </div>
                ...
                <div className="min-w-0 space-y-3">
                  <div>
                    <p className="text-sm font-bold text-slate-800">Tanda Tangan Digital</p>
                    <p className="mt-1 max-w-xl text-xs leading-relaxed text-slate-500">
                      Gambar akan ditempatkan di atas nama penandatangan pada preview, PDF, lampiran email, dan DOCX.
                      Gunakan PNG transparan agar hasil cetak terlihat natural.
                    </p>
                  </div>
                  ...
                  <p className="text-[11px] text-slate-400">
                    PNG atau JPG · Maksimal 2 MB · Pastikan Anda berwenang menggunakan tanda tangan ini.
                  </p>
                </div>
              </div>
