...
export function LandingPage({ isLoggedIn, hasCompany, stats }: LandingPageProps) {
  ...
  const [activePreviewTab, setActivePreviewTab] = useState<"invoice" | "penawaran" | "quotation" | "bast" | "kontrak">("invoice");
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
          <Link href="/" className="flex items-center gap-2.5 group">
            <img src="/icon.svg" alt="Dokgen" className="h-7 w-7 rounded-md shadow-2xs group-hover:scale-105 transition-transform" />
      ...
      <section className="pt-8 pb-12 sm:pt-12 sm:pb-20 md:pt-16 md:pb-24">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 text-center">
          ...
          <p className="mx-auto mt-3 sm:mt-4 max-w-2xl text-xs sm:text-base text-slate-600 leading-relaxed px-1">
            Platform manajemen dokumen keuangan & legal perusahaan. Format standar resmi, ekspor PDF & Word (.docx) presisi,
            dukungan multi-rekening bank, dan pengiriman langsung via WA / Email.
          </p>
          ...
          <div className="mt-6 sm:mt-7 flex flex-col sm:flex-row items-center justify-center gap-2.5 sm:gap-3">
            <Link href={actionUrl} className="w-full sm:w-auto">
              <Button size="default" className="w-full sm:w-auto bg-blue-600 font-semibold text-white px-6 text-xs sm:text-sm shadow-2xs hover:bg-blue-700 py-2.5 sm:py-2">
                {actionText} <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
            <a href="#fitur" className="w-full sm:w-auto">
              <Button variant="outline" size="default" className="w-full sm:w-auto border-slate-300 bg-white text-slate-700 px-6 text-xs sm:text-sm hover:bg-slate-50 py-2.5 sm:py-2">
            ...
            {docTypes.map((dt) => {
              ...
              return (
                <button
                  key={dt.id}
                  type="button"
                  onClick={() => setActivePreviewTab(dt.id as any)}
                ...
                >
                  <span className="sm:hidden">{dt.badge === "Serah Terima" ? "BAST" : dt.badge === "Tagihan" ? "Faktur (Invoice)" : dt.badge === "Penawaran" ? "Surat Penawaran" : dt.title}</span>
            ...
            <div className="rounded-lg border border-slate-200 bg-slate-50/50 p-3 sm:p-6 space-y-4 sm:space-y-5 text-xs">
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-2 border-b-2 border-slate-800 pb-3">
                <div>
                  ...
                  <p className="text-slate-500 text-[10px] sm:text-[11px]">Digital Services & Solution · Jakarta Pusat</p>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="sm:text-right space-y-0.5">
                  <p className="text-slate-600 text-[11px]">Tanggal Dokumen: <span className="font-medium text-slate-900">4 Agustus 2026</span></p>
                  {activePreviewTab === "invoice" && (
                    <>
                      <p className="text-slate-600 text-[11px]">Jatuh Tempo: <span className="font-medium text-slate-900">18 Agustus 2026</span></p>
                  ...
                  {activePreviewTab === "penawaran" && (
                    <p className="text-slate-600 text-[11px]">Masa Berlaku: <span className="font-medium text-slate-900">14 Hari Kerja</span></p>
                  )}
                  {activePreviewTab === "quotation" && (
                    <p className="text-slate-600 text-[11px]">Estimasi Pelaksanaan: <span className="font-medium text-slate-900">10 Hari Kerja</span></p>
                  )}
              ...
              {activePreviewTab === "bast" ? (
                ...
                <div className="space-y-3">
                  <p className="text-[11px] text-slate-600 leading-relaxed">
                    Pada hari ini <strong>Selasa, 4 Agustus 2026</strong>, telah dilaksanakan serah terima hasil pekerjaan antara <strong>PIHAK PERTAMA</strong> (PT MAJU SEJAHTERA DIGITAL) dan <strong>PIHAK KEDUA</strong> (PT CONTOH KLIEN NUSANTARA).
                  </p>
                  <div className="rounded border border-slate-200 bg-white p-3 space-y-1">
                    ...
                    <p className="text-slate-600 text-[11px]">1. Pengembangan Web Company Profile & CMS (Selesai 100%)</p>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-2 text-center text-[11px]">
                    <div className="border border-slate-200 bg-white rounded p-2">
                      ...
                      <div className="h-10 my-1 flex items-center justify-center text-slate-400 italic text-[10px]">[Tanda Tangan Digital]</div>
                ...
                <div className="space-y-3">
                  <div className="rounded border border-slate-200 bg-white p-3 space-y-2 text-[11px]">
                    <div>
                      ...
                      <p className="text-slate-600">Pihak Pertama berkewajiban menyelesaikan perancangan sistem informasi sesuai spesifikasi teknis yang disepakati.</p>
                    </div>
                    <div>
                      <span className="font-bold text-slate-900">Pasal 2 - Nilai Kontrak & Pembayaran</span>
                      <p className="text-slate-600">Nilai kontrak disepakati sebesar Rp 25.000.000 yang dibayarkan dalam 2 tahap termin pembayaran.</p>
                    </div>
                    <div>
                      <span className="font-bold text-slate-900">Pasal 3 - Kerahasiaan Data</span>
                      <p className="text-slate-600">Para pihak sepakat untuk menjaga kerahasiaan seluruh data dan informasi perusahaan.</p>
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4 pt-1 text-center text-[11px]">
                    <div className="border border-slate-200 bg-white rounded p-2">
                      <p className="text-slate-500">PIHAK PERTAMA</p>
                      <div className="h-8 my-1 flex items-center justify-center text-slate-400 italic text-[10px]">[Stempel & TTD]</div>
                ...
                <>
                        ...
                        {activePreviewTab === "penawaran" ? (
                          <>
                            <tr>
                              ...
                              <td className="p-2 font-medium text-slate-900">Perancangan Sistem Aplikasi e-Procurement</td>
                            ...
                            <tr>
                              ...
                              <td className="p-2 font-medium text-slate-900">Pelatihan User & Pemeliharaan System (6 Bulan)</td>
                              <td className="p-2 text-center">1 paket</td>
                          ...
                          <>
                            <tr>
                              <td className="p-2 text-center font-medium text-slate-500">1</td>
                              <td className="p-2 font-medium text-slate-900">Audit Keamanan Sistem & Web Vulnerability Assessment</td>
                            ...
                            <tr>
                              <td className="p-2 text-center font-medium text-slate-500">2</td>
                              <td className="p-2 font-medium text-slate-900">Laporan Penilaian & Recommendations Report</td>
                          ...
                          <>
                            <tr>
                              <td className="p-2 text-center font-medium text-slate-500">1</td>
                              <td className="p-2 font-medium text-slate-900">Jasa Desain Branding & Graphic Identity</td>
                  ...
                  {activePreviewTab === "penawaran" && (
                    <div className="rounded border border-slate-200 bg-white p-2.5 space-y-1.5">
                      <p className="font-bold text-slate-900 text-xs">Spesifikasi & Lingkup Pekerjaan (Scope of Work):</p>
                      <div className="grid grid-cols-3 gap-2 text-[10px] text-slate-600 font-medium border-t border-slate-100 pt-1.5">
                        <div><strong>1. Analisis:</strong> Identifikasi alur kerja & kebutuhan sistem</div>
                        <div><strong>2. UI/UX:</strong> Desain antarmuka responsif & interaktif</div>
                        <div><strong>3. Backend:</strong> Integrasi API & Enkripsi data PostgreSQL</div>
                      </div>
                    </div>
                  )}
                    ...
                    <div className="text-left sm:text-right w-full sm:w-auto flex justify-between sm:block">
                      ...
                      <div>
                        ...
                        <p className="text-base sm:text-lg font-bold text-slate-900">
                          {activePreviewTab === "penawaran" ? "Rp 20.000.000" : activePreviewTab === "quotation" ? "Rp 4.000.000" : "Rp 5.000.000"}
                        </p>
                        <p className="text-[10px] text-slate-500 italic hidden sm:block">
                          Terbilang: {activePreviewTab === "penawaran" ? "Dua Puluh Juta Rupiah" : activePreviewTab === "quotation" ? "Empat Juta Rupiah" : "Lima Juta Rupiah"}
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <section id="fitur" className="border-t border-slate-200 bg-white py-10 sm:py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="mt-1 text-xl font-bold text-slate-900 sm:text-3xl">
              Fitur Utama Generator Dokumen Dokgen
            </h2>
      ...
      <section id="jenis-dokumen" className="py-10 sm:py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="mt-1 text-xl font-bold text-slate-900 sm:text-3xl">
              5 Jenis Dokumen Standar Bisnis
            </h2>
          </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown className={`h-4 w-4 shrink-0 text-slate-500 transition-transform ${isOpen ? "rotate-180 text-blue-600" : ""}`} />
                  </button>
                  {isOpen && (
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-10 text-center sm:text-left shadow-xs flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
            <div className="max-w-xl">
              <h2 className="text-lg font-bold text-slate-900 sm:text-2xl">
                Mulai Buat Dokumen Bisnis Anda Sekarang
              </h2>
      ...
      <footer className="border-t border-slate-200 bg-white py-6 text-slate-500 text-xs">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-slate-600 font-medium text-xs">
            ...
            <a href="#jenis-dokumen" className="hover:text-blue-600 transition-colors">Jenis Dokumen</a>
